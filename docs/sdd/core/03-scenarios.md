...
> **实现状态：** 跳转与自动筛选见 **§17.8 UI-NAV-01~03**（**已完成 2026-07-03**）。
...
> **实现状态：** 供需平衡专页、API-MAT-01~08、**SCN-07d OPTIMIZE**、多路径 ENT-RT **已实现**（2026-07-02）。
...
> **实现状态：** SCN-07e~j、API-MAT-04~08 **已实现**（2026-07-02）；UI 为点击预留（非拖拽）。
