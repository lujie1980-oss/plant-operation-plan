...
> **实现差距：** 本体类型 **ENT-RCA** 已纳入 `OntologyGraph`（TODO-22 **R1 已完成 2026-07-01**）；求解器包 `com.plantops.solver.masterplan.ResourceCapacityAssignment` 仍绑定 `TimeSlot` / 日拆段；写回与投影见 **R2~R3**。
