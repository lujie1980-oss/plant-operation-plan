...
| AC-PERS-01 | 给定 COMMITTED `revision_id`，`OntologyRestorer.load` 与迁移前 `OntologyLoader.build` 在 FF/SO/Operation/PISPP 关键字段 **对等** | PERS-01 | `OntologyRestorerIntegrationTest`（P0 子集；生产读路径待 P1 收口） |
