...
ALTER TABLE production_resource ADD COLUMN resource_efficiency DECIMAL(8, 4) NOT NULL DEFAULT 1.0;

CREATE TABLE delivery_date_strategy (
...
CREATE SEQUENCE IF NOT EXISTS delivery_date_strategy_SEQ START WITH 1 INCREMENT BY 50;

CREATE TABLE supply_quantity_rule (
    id BIGINT NOT NULL PRIMARY KEY,
    workspace_id VARCHAR(64) NOT NULL,
    product_code VARCHAR(128) NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS supply_quantity_rule_SEQ START WITH 1 INCREMENT BY 50;

CREATE TABLE routing_step_timing_rule (
    id BIGINT NOT NULL PRIMARY KEY,
    workspace_id VARCHAR(64) NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS routing_step_timing_rule_SEQ START WITH 1 INCREMENT BY 50;

CREATE TABLE routing_step_resource_rule (
    id BIGINT NOT NULL PRIMARY KEY,
    workspace_id VARCHAR(64) NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS routing_step_resource_rule_SEQ START WITH 1 INCREMENT BY 50;
